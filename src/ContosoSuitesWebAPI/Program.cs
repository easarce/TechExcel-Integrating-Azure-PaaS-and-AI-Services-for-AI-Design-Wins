...
// Create a single instance of the Semantic kernel to be shared across the application. added by Edwin
...
app.MapGet("/", async () => 
{
    return "Welcome to the Contoso Suites Web API! Dec 10th";
})
    .WithName("Index")
    .WithOpenApi();
...
// This endpoint is used to send a message to the Azure OpenAI endpoint. Modified by Edwin
